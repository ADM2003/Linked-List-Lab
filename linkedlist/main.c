...
int main() {
  ...
  if(strcmp("100->90->80->70->60->50->40->30->20->10->NULL",listToString(mylist)) != 0)
  {
    ...
    printf("list_add_to_front : SUCCESS\n");
  }
  ...
  if(strcmp("100->90->80->60->50->40->30->20->10->NULL",listToString(mylist)) != 0)
  {
    ...
    printf("list_remove_at_index : SUCCESS\n");
  }
  ...
  list_print(mylist);
  if(strcmp("100->80->60->50->40->30->NULL",listToString(mylist)) != 0)
  {
        printf("list_remove_from_back : FAILED\n");
  }
  else{
    printf("list_remove_from_back : SUCCESS\n");
  }

  list_remove_from_front(mylist);
  list_print(mylist);
  if(strcmp("80->60->50->40->30->NULL",listToString(mylist)) != 0)
  {
        printf("list_remove_from_front : FAILED\n");
  }
  else{
    printf("list_remove_from_front : SUCCESS\n");
  }

list_add_to_back(mylist, 20);
list_print(mylist);
if(strcmp("80->60->50->40->30->20->NULL",listToString(mylist)) != 0)
  {
        printf("list_add_to_back : FAILED\n");
  }
  else{
    printf("list_add_to_back : SUCCESS\n");
  }

list_add_at_index(mylist, 70, 1);
list_print(mylist);
if(strcmp("80->70->60->50->40->30->20->NULL",listToString(mylist)) != 0)
  {
        printf("list_add_at_index : FAILED\n");
  }
  else{
    printf("list_add_at_index : SUCCESS\n");
  }
  ...
  // list_remove_at_index(mylist, 0);
  // list_print(mylist);
  // printf("Removing at invalid index -2:\n");
  // list_remove_at_index(mylist, -2);
  // list_print(mylist);
